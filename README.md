...
3. Installation
    ...
    - You should now be ready to test the application. In the directory, type either <code>flask --app server run</code> or <code>python -m flask run</code>. The app should respond with an address you should be able to go to using your browser.
